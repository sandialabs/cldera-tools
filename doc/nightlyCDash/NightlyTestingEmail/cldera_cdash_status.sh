#!/bin/bash
#
# Analyze the CLDERA-E3SM build on CDash for a given date.
#
# Usage:
#
#    cldera_cdash_status.sh [--date=<YYYY-MM-DD>] \
...
--cdash-project-name="CLDERA" \
--build-set-name="CLDERA-E3SM Nightly Builds" \
--cdash-site-url="https://my.cdash.org" \
--cdash-builds-filters="filtercount=1&showfilters=1&field1=groupname&compare1=61&value1=CLDERA-E3SM" \
--cdash-nonpassed-tests-filters="filtercount=2&showfilters=1&filtercombine=and&field1=groupname&compare1=61&value1=CLDERA-E3SM&field2=status&compare2=62&value2=passed" \
--require-test-history-match-nonpassing-tests=off \
--limit-table-rows=50 \
--write-failing-tests-without-issue-trackers-to-file="clderaNightlyBuildsTwoif.csv" \
--write-email-to-file="clderaNightlyBuilds.html" \
--expected-builds-file="CLDERAExpectedBuilds.csv" \
"$@"

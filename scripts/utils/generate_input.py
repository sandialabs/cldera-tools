...
if __name__ == "__main__":
    ...
    # mask_loc = '/projects/cldera/cldera-tools/input' # Sandia HPC
    # mask_loc = '/sems-data-store/ACME/cldera/cldera-tools/input' # Mappy
    mask_loc = '/global/cfs/cdirs/m4014/cldera-tools/input' # Perlmutter
